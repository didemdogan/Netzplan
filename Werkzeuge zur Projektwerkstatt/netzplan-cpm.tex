...
% andere Möglichkeit zum Einblenden/Ausblenden, aber Pfeile bleiben...
%\begin{itemize}
%\item<1->
%\only<1>{Dein Netzplan beginnt immer bei einem FA von 0}
%\item<2->
%\only<2>{Suche alle Vorgänge ohne Vorgänger (siehe Liste). Alle diese Pfeile gehen von unserem ersten Knoten aus. %Schreibe die Tätigkeiten (in Kurzform), sowie Aufwand/Dauer auf den Pfeil.}
%\end{itemize}
